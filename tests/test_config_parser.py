            ...
            "localhost": [
                {
                    ...
                    "cmd": "ros2 run run-some-nodes.exec.py",
                    "machine": "localhost",
                }
            ],
            "192.168.1.2": [
                {
                    "image": "ros:humble-ros-base",
                    "cmd": "ros2 run run-other-nodes.exec.py",
                    "machine": "192.168.1.2",
                }
            ],
            None: [
